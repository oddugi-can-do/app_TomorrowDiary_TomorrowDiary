...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.csdcorp.local_image_provider.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.csdcorp.local_image_provider.GlideOptions().apply(toSet));
    }
  }
}
