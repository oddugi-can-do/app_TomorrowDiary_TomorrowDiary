...
// class SignUpForm extends GetWidget<FirebaseAuthState> {
//   GlobalKey<FormState> _formKey = GlobalKey<FormState>(); // Form에 대한 상태를 알기 위해 필요한 키이다.
...
//                       controller.createUser(email: _emailController.text, password: _passwordController.text);
